...
solver.set_initial_condition(u, v, density, sb, 0*sb + 1e-10)

E0 = solver.integrate(solver.energy()).numpy()
print('Energy:', E0)

plot_func = lambda s: s.potential_temperature
...
plt.savefig(f'./plots/2D-moist-bubble-snaps-n{nx}-p{poly_order}.png')
plt.show()
