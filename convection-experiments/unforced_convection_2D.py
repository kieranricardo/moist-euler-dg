...
if SST is None:
    exp_name_short = 'unforced-convection'
else:
    exp_name_short = f'unforced-convection-sst-{SST}K'
...
if run_model:
    ...
    u, v, density, s, qw, T = initial_condition(solver)
...
# plotting
    ...
    _, _, h0, s0, qw0, T0 = initial_condition(solver_plot)
